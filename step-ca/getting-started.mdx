...
You can use `step ca` and `step ssh` command groups to interact with the CA. See [Basic CA Operations](/docs/step-ca/basic-certificate-authority-operations) for an overview of common operations.
