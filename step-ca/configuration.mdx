...
<Alert severity="info" id="star11">
  <div>
    ...
    For example, the `.Insecure.CR` variable holds the user-supplied Certificate Request.
  </div>
</Alert>
...
* **.Insecure.CR**<Reference id="star11" marker="*" /> This field holds the Certificate Request from the client.
...
<Alert severity="warning">
  <div>
    ...
    If you've added an OIDC admin user to you CA configuration,
    and you add an SSH certificate template,
    you will lose the OIDC provisioner admin privilege of being able to supply arbitrary `--principal` values when requesting an SSH certificate.
    This is because the CA usually uses a different [default template for admin users](https://github.com/smallstep/crypto/blob/162770cad29063385cb768b0191814e4c6a94e45/sshutil/templates.go#L152).
  </div>
</Alert>
