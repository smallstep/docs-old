...
- **Easy to use, hard to misuse:** Safe defaults everywhere encourage best practices by always making the right thing easy. Insecure or subtle operations are gated with flags to precent accidental misuse.
