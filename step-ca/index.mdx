...
<Alert severity="success">
  ...
  <div>
    ...
    <Link
      external
      href="https://info.smallstep.com/certificate-manager-early-access-mvp/"
    >
...
- Operate a local [Registration Authority (RA)](/docs/step-ca/configuration#registration-authority-ra-mode) on an internal network or inside a Kubernetes cluster, that authorizes certificate requests for an upstream `step-ca` server.
