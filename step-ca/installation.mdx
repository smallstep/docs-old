...
1. Install `step`
    ...
    sudo dpkg -i step_0.15.8_amd64.deb
    ```
...
1. Install `step`
    ...
    ```shell
    wget -O step.tar.gz https://github.com/smallstep/cli/releases/download/v0.15.8/step_linux_0.15.8_amd64.tar.gz
    tar -xf step.tar.gz
    sudo cp step_0.15.8/bin/step /usr/bin
    ```
