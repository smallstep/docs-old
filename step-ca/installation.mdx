...
1. Install `step`
    ...
    ```shell
    wget https://github.com/smallstep/cli/releases/download/v0.15.9/step-cli_0.15.9_amd64.deb
    sudo dpkg -i step-cli_0.15.9_amd64.deb
    ```
...
1. Install `step`
    ...
    ```shell
    wget -O step.tar.gz https://github.com/smallstep/cli/releases/download/v0.15.9/step_linux_0.15.9_amd64.tar.gz
    tar -xf step.tar.gz
    sudo cp step_0.15.9/bin/step /usr/bin
    ```
