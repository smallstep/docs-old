...
1. Install `step`
    ...
    ```shell
    wget https://dl.step.sm/cli/v0.17.2/step-cli_0.17.2_amd64.deb
...
2. Install `step-ca`
    ...
    ```shell
    wget https://dl.step.sm/certificates/v0.17.2/step-ca_0.17.2_amd64.deb
...
1. Install `step`
    ...
    ```shell
    wget -O step.tar.gz https://dl.step.sm/cli/v0.17.2/step_linux_0.17.2_amd64.tar.gz
    tar -xf step.tar.gz
...
2. Install `step-ca`
    ...
    ```shell
    wget -O step-ca.tar.gz https://dl.step.sm/certificates/v0.17.2/step-ca_linux_0.17.2_amd64.tar.gz
