...
1. Install `step`
    ...
    ```shell
    wget https://github.com/smallstep/cli/releases/download/v0.15.16/step-cli_0.15.16_amd64.deb
...
2. Install `step-ca`
    ...
    ```shell
    wget https://github.com/smallstep/certificates/releases/download/v0.15.14/step-ca_0.15.14_amd64.deb
    sudo dpkg -i step-ca_0.15.14_amd64.deb
    ```
