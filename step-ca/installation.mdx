...
1. Install `step`
    ...
    ```shell
    wget https://dl.step.sm/gh-release/cli/docs-ca-install/v0.17.2/step-cli_0.17.2_amd64.deb
...
2. Install `step-ca`
    ...
    ```shell
    wget https://dl.step.sm/gh-release/certificates/docs-ca-install/v0.17.2/step-ca_0.17.2_amd64.deb
...
1. Install `step`
    ...
    ```shell
    wget -O step.tar.gz https://dl.step.sm/gh-release/cli/docs-ca-install/v0.17.2/step_linux_0.17.2_amd64.tar.gz
    tar -xf step.tar.gz
    sudo cp step_0.17.2/bin/step /usr/bin
    ```
...
2. Install `step-ca`
    ...
    ```shell
    wget -O step-ca.tar.gz https://dl.step.sm/gh-release/certificates/docs-ca-install/v0.17.2/step-ca_linux_0.17.2_amd64.tar.gz
    tar -xf step-ca.tar.gz
    sudo cp step-ca_0.17.2/bin/step-ca /usr/bin
    ```
