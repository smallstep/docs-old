...
#### For X.509/TLS certificate authorities:
- Learn about the [core concepts and design principles](/docs/step-ca/certificate-authority-core-concepts) behind `step-ca`.
- Read the [Getting Started X.509/TLS guide](/docs/step-ca/getting-started) to set up a CA and get your first certificate.

#### For SSH certificate authorities:
- Learn about the [core concepts and design principles](/docs/step-ca/ssh-certificate-authority-core-concepts) behind `step-ca`.
- Read the [Getting Started SSH guide](/docs/step-ca/ssh-getting-started) to set up a CA and get your first certificate.
