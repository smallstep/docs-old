...
1. Install `step`
    ...
    ```shell
    wget -O step.tar.gz https://github.com/smallstep/cli/releases/download/v0.17.2/step_linux_0.17.2_amd64.tar.gz
    tar -xf step.tar.gz
...
2. Install `step-ca`
    ...
    ```shell
    wget -O step-ca.tar.gz https://github.com/smallstep/certificates/releases/download/v0.17.2/step-ca_linux_0.17.2_amd64.tar.gz
