...
Templates are an open-source feature. Visit the `[step-ca` documentation](https://smallstep.com/docs/step-ca/configuration#certificate-templates) for a complete description of Templates and instructions on usage and capabilities.
