...
Authorities are an open-source feature. The best way to learn about Authorities is to create one for yourself. Follow the instructions on [the `step-ca` getting started page](/docs/step-ca/getting-started) and you will have your own Authority in no time at all.
