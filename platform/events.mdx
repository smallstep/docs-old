...
description: "/docs/platform - Learn about the Smallstep Platform"
unfurl: /static/graphics/smallstep-docs-unfurl.png
---

# **Events**

Events power alerting for certificate lifecycle activities. Used to help administrators operate the Smallstep Platform, Events can be generated and surfaced via standard mechanisms. You can use Events to:
...
Events are a feature of the commercial [Smallstep Certificate Manager](https://smallstep.com/certificate-manager/) offering. Available in **1H 2021**
