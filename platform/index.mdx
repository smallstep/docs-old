...
The Smallstep Platform is an opinionated, extensible toolkit for DevSecOps public key infrastructure (PKI). I contains a number of components that can be combined to deliver automated certificate management for a broad set of use cases and implementations. The components include:
