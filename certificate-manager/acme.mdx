...
<Alert severity="info">
  <div>
    See Smallstep certificate Manager in action. Watch the [create a private ACME server in less than 10 mins video](https://u.step.sm/how-to-CM-private-ACME-server).
  </div>
</Alert>
