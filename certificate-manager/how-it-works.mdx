...
![Certificate Templates](/images/homepage/templates-screenshot.svg "Certificate Templates")
...
2. [**Roll your own**](/docs/step-ca/getting-started)- Use open-source `step-ca`.
3. [**Get advice**](/request-demo)- Talk to Smallstep about your project.
