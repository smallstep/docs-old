...
- **[Smallstep Certificate Manager](/docs/certificate-manager/acme) -** this tutorial assumes you have created a hosted or linked authority and are running a local [ACME Registration Authority](/docs/registration-authorities/acme-for-certificate-manager). 
