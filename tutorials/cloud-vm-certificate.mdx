...
html_title: Cloud VM certificate use metadata API for PKI auto-enroll
description: Use the cloud metadata API to make it embarrassingly easy to get private PKI certificates to workloads running on AWS, GCP, and Azure virtual machines (VMs)
...
[6]: ../../../static/images/iid-authentication.png
[7]: /docs/step-ca/configuration#cloud-provisioners
[8]: https://docs.aws.amazon.com/general/latest/gr/acct-identifiers.html
[9]: ../../../static/images/aws-account-id.png
...
authentication isn’t right for you. Use [autocert][11] or [cert-manager
