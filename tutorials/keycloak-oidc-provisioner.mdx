...
- **Open source -** This tutorial assumes you have initialized a `step-ca` instance using the steps in [Getting Started](/docs/step-ca/getting-started). 
- **[Smallstep Certificate Manager](/certificate-manager) -** Please visit the [OIDC documentation](/docs/certificate-manager/oidc) instead of using this tutorial for instructions on connecting keycloak to Certificate Manager.
