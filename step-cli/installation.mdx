...
```shell
wget https://github.com/smallstep/cli/releases/download/v0.15.17/step-cli_0.15.17_amd64.deb
sudo dpkg -i step-cli_0.15.17_amd64.deb
```
...
```shell
curl.exe -LO https://github.com/smallstep/cli/releases/download/v0.15.17/step_windows_0.15.17_amd64.zip
Expand-Archive -LiteralPath .\step_windows_0.15.17_amd64.zip -DestinationPath .
step_0.15.17\bin\step.exe version
```
