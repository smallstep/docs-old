...
```shell
wget https://dl.step.sm/gh-release/cli/docs-cli-install/v0.17.5/step-cli_0.17.5_amd64.deb
...
```shell
curl.exe -LO https://dl.step.sm/gh-release/cli/docs-cli-install/v0.17.5/step_windows_0.17.5_amd64.zip
Expand-Archive -LiteralPath .\step_windows_0.17.5_amd64.zip -DestinationPath .
step_0.17.5\bin\step.exe version
```
