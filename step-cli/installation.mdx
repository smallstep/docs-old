...
```shell
PS C:\Users\Administrator> curl.exe -LO https://github.com/smallstep/cli/releases/download/v0.15.8/step_windows_0.15.8_amd64.zip
PS C:\Users\Administrator> Expand-Archive -LiteralPath .\step_windows_0.15.8_amd64.zip
PS C:\Users\Administrator> .\step.exe --version
Smallstep CLI/0.15.8 (windows/amd64)
