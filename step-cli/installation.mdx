...
```shell
curl.exe -LO https://github.com/smallstep/cli/releases/download/v0.15.16/step_windows_0.15.16_amd64.zip
Expand-Archive -LiteralPath .\step_windows_0.15.16_amd64.zip -DestinationPath .
step_0.15.16\bin\step.exe version
```
