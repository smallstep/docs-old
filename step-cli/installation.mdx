...
There is a community-maintained [`step-cli` package](https://pkgs.alpinelinux.org/package/edge/testing/x86/step-cli) Alpine Linux Package.
...
```shell
PS C:\Users\Smallstep> curl.exe -LO https://github.com/smallstep/cli/releases/download/v0.15.16/step_windows_0.15.16_amd64.zip
PS C:\Users\Smallstep> Expand-Archive -LiteralPath .\step_windows_0.15.16_amd64.zip
PS C:\Users\Smallstep> .\step.exe --version
Smallstep CLI/0.15.16 (windows/amd64)
Release Date: 2021-04-15T22:33:22Z
```
