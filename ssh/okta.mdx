...
* An account on the smallstep platform  
  Need one? [Register here](https://info.smallstep.com/signup/)
* Okta Super Administrator privileges
* Okta Universal Directory Subscription
* Okta Advanced Lifecycle Management Subscription (for SCIM support)
* Okta API Access Management Subscription (for OIDC SSO support)
