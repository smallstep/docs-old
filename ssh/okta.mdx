...
2. Navigate the Onboarding Dialog. If the dialog is not open, you can relaunch it by visiting the "USERS" page.

   ![](/static/graphics/quickstart/oidc-copy-2021.png "onboarding")
...
* Return to Smallstep UI or open a new browser tab and sign into the Smallstep UI: `https://smallstep.com/app/[TEAM-NAME]`
* Navigate to the Onboarding UI > Add Your Team > SCIM Details
* Copy **Base URL,** and **API token** from Smallstep UI and Paste into Okta Provisioning form.
* In Okta Provisioning form click Test API Credentials, after successful verification, click Save

  ![](/static/graphics/quickstart/okta-api-auth.png "API Auth")

* Reload the provision tab
* Under Provisioning > Settings >To App click "edit" and enable
  * Create Users
