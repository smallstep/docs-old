...
![Smallstep SSH](/static/graphics/docs-ssh-logo.png "Smallstep SSH")

Before you begin, [register for a smallstep account](https://info.smallstep.com/signup/) if you haven't already.
