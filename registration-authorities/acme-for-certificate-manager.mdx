...
import { parseQueryParam } from 'docs/DocUtils';

export const ca_url = () => parseQueryParam('caUrl', 'https://ra.example.com')
export const fingerprint = () => parseQueryParam('fingerprint', 'b4fc6b547ca4610b69cfcc53c6933e7a37170476dfe13EXAMPLE92c403f5')
export const provisioner = () => parseQueryParam('provisioner', 'acme-ra-jwk')
export const address = () => parseQueryParam('address', ':443')
export const dns = () => parseQueryParam('dns', 'ra.example.com')
