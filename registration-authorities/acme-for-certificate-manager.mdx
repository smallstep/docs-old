...
import DnyamicDocForm from 'docs/DnyamicDocForm';
...
export const provisioner = () => router().query.provisioner && router().query.provisioner.length ? router().query.provisioner : "ra@example.com"
export const dns = () => {
