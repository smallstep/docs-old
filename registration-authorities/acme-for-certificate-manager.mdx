...
export const ca_url = () => query_string('caUrl', 'https://ra.example.com')
export const fingerprint = () => query_string('fingerprint', 'b4fc6b547ca4610b69cfcc53c6933e7a37170476dfe13EXAMPLE92c403f5')
export const provisioner = () => query_string('provisioner', 'acme-ra-jwk')
export const address = () => query_string('address', ':443')
export const dns = () => query_string('dns', 'ra.example.com')
