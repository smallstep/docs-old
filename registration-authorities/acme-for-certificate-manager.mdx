...
import DocsForm from 'docs/DocsValidatedInput';

export const router = () => useRouter();
export const ca_url = () => router().query.caUrl ? router().query.caUrl : "https://ra.example.com"
export const fingerprint = () => router().query.fingerprint ? router().query.fingerprint : "b4fc6b547ca4610b69cfcc53c6933e7a37170476dfe13EXAMPLE92c403f5"
export const provisioner = () => router().query.provisioner ? router().query.provisioner : "ra@example.com"
...
- A host or Kubernetes cluster where you can run the Registration Authority
 ...
 Use this form to help autogenerate content
  <DocsForm  formFields={formFields} baseUrl="/docs/registration-authorities/acme-for-certificate-manager" />
